...
## License
pRIblast is free software and as such it is distributed under the [MIT License](licenses/MIT.txt). However, pRIblast makes use of a header-only module (see [minmaxheap.h](src/minmaxheap.h)) which is not an original piece of work. Therefore, its usage is subject to the [GPLv3](licenses/GPL3.txt) License and all rights are reserved to [Kilian Gebhardt](https://github.com/kilian-gebhardt).
