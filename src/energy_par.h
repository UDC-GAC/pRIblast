...
static double lxc37 =
    107.856; /* parameter for logarithmic loop energy extrapolation*/
...
static int hairpin37[31] = {INF, INF, INF, 364, 282, 297, 287, 259,
                            259, 272, 283, 293, 303, 311, 319, 327,
                            334, 340, 346, 352, 358, 363, 368, 373,
                            377, 382, 386, 390, 394, 398, 401};
...
static int bulge37[31] = {INF, 281, 157, 201, 288, 298, 272, 288, 303, 315, 327,
                          337, 346, 355, 363, 370, 377, 384, 390, 396, 401, 407,
                          412, 416, 421, 425, 430, 434, 438, 442, 445};

static int TerminalAU = 56;

static int internal_loop37[31] = {INF, INF, INF, INF, 83,  118, 90,  106,
                                  121, 133, 145, 155, 164, 173, 181, 188,
                                  195, 202, 208, 214, 219, 225, 230, 234,
                                  239, 243, 248, 252, 256, 260, 263};
